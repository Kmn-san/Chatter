import { View, Text, Pressable, KeyboardAvoidingView, Platform, ActivityIndicator, TextInput, ScrollView } from 'react-native'
...
const ChatDetailScreen = () => {
  ...
  //scrool to bottom when new messages arrive
  useEffect(() => {
        ...
        <View className="flex-1 bg-surface">
          ...
          <View className="px-3 pb-3 pt-2 bg-surface border-t border-surface-light">
            <View className="flex-row items-end bg-surface-card rounded-3xl px-3 py-2 gap-2">
              ...
              <Pressable
                className="w-8 h-8 rounded-full items-center justify-center bg-primary mb-1"
                onPress={handleSend}
